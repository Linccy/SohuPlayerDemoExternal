...
package com.sohuvideo.playerdemo.testswitch;
...
public class SwitchButton extends CompoundButton {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mOnLayout == null) {
            mTextPaint.setColor(mContext.getResources().getColor(R.color.white_color));
            mOnLayout = makeLayout(mTextOn);
        }
        if (mOffLayout == null) {
            mTextPaint.setColor(mContext.getResources().getColor(R.color.gray2_color));
   ...
   /* @Override
    ...
    public void setChecked(boolean checked) {
        ...
        if(isChecked != checked && mOnSwitchListener != null){
            mOnSwitchListener.onSwitched(this, checked);
        }
        Log.d("SvenDebug", "setChecked :" +checked);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        Log.d("SvenDebug", "onLayout :: isChecked:" + isChecked());
...
/*        if (mTextColors != null) {
        ...
        Log.d("SvenDebug", "onDraw :: getTargetCheckedState:" + getTargetCheckedState());
    ...
    public interface OnSwitchListener {
        abstract void onSwitched(SwitchButton view, boolean isSwitchOn);
    }
}
